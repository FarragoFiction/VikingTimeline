...
function QuadrantDialogue(session){
	...
	*/
	...
	this.chatAboutRomance = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		var chats = [];
		//chats.push(new InterestConversationalPair(interest, "", ["","",""], ["", "", "","", ""]));
		chats.push(new InterestConversationalPair(interest, "Gosh, do you know what everybody being dead means? Our SOUL MATES must be the other players! That makes it WAY more likely to find them!", ["omg i hadn't though of it in that light!","You are so right. Romance for everybody!","But, what if you're wrong and our soulmates died in the apocalypse?", "... I MUST UPDATE THE SHIPPING CHARTS."], ["Huh, what's that strange sensation? Oh, it must be my brain dribbling out of my ears. People DIED, asshole.", "God, how stupid can you get, that's not how soul mates work, asshole.", "Even that IS true, it's not worth billions of people dying, asshole.", "Glad you can find the silver lining on the DEATH OF OUR SPECIES."]));
	...
	this.chatAboutTechnology = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		var chats = [];
		chats.push(new InterestConversationalPair(interest, "Hey, what operating system are you running again? I just realized alchemy could let me improve it.", ["Oh please, I've been running some crappy old junker since I got in the game, I need an upgrade so bad.","Some old gaming computer. Its full of patches and shit, but I'd definitely be up for a tune up.","You should remember, you gave me my last one!", "Homemade all day. I'm more then willing to let you peak around the inside tho."], ["I have a faster system then you could even dream of.", "Stay the fuck away from my Wilson.", "The last time you offered to improve my comp it ran about 38.2% slower. I'm not letting you back in.","You blew up my last computer, asshole. I'm stuck on a shitty oldbox because of you.", "Eat shit and die asshole."]));
	...
	this.chatAboutCulture = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		var chats = [];
		chats.push(new InterestConversationalPair(interest, "Did you ever go see that opera I told you about?", ["Oh no! I never got too! And now the planet's dead and I'll never be able too! D:","Yeah, its such a pity the lead singer is dead now.","Oh hell yes, that opera was amazing. That solo when the heroine died? Priceless.", "Yeah, I saw that TEN TIMES. It rocked."], ["Ugh, of course not. That theater had been over for years, it went for spectacle over anything meaningful. Of course you'd like it.", "Yes, It was garbage. I can't believe you could enjoy something so pedestrian and boring.", "Yeah, the singer's voice went screwy partway through. Why the hell would you like something like that?","Don't remind me. It was complete and total shit.", "Of course not. I make it a matter of policy to not go see anything you enjoy. Your taste is simply the worst there is."]));
	...
	this.chatAboutDomestic = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		var chats = [];
		chats.push(new InterestConversationalPair(interest, "I need to tidy your home some time", ["Ugh, yeah, its becoming such a mess.","That sounds like a great excuse for you to get the hell over here.","I'd say Spring Cleaning, but I'm not sure SBURB has seasons."], ["I have a system and you will learn a new meaning of pain if you try to messs with it.", "God no, you'd only make it look worse.", "You had a pair of socks hanging over your computer last time I was over, no WAY am I trusting you near my house.","Hahahahah fuck no.", "You can take your cleaning mania and stick up your ass."]));
		chats.push(new InterestConversationalPair(interest, "Remind me to alchemize some new clothes for you later.", ["Oh man, I bet they'd look so cool!","Really!? You have such good taste in fashion!","I can't wait!", "Would this be a private fitting? *waggles eyebrows*"], ["Ugh, never in a million years. You have shit taste.", "Remind me to take a holy vow against wearing clothes later.", "Not if they were the last pair of pants in existance.","Ugh, just imagining wearing something with your shit taste makes me feel debased.", "Jesus why are you wasting grist on clothes? Especially clothes designed by you?"]));
	...
	this.chatAboutTerrible = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		chats.push(new InterestConversationalPair(interest, "Hell yes, I've got all the boonies, baby.", ["Bling bling, yes.","Man, you have fat stacks and mad cash.","So rich you could buy Derse if you wanted to.", "Make money get paid, lets do this shit!"], ["What do you want, a gold star? Money is stupid easy to get in this game.", "And just like that, my desire for money is down the toilet.", "If you even remotely had a heart, you'd stop bragging about shit like that when the entire world just ended.", "Shit, your still on boonies? I've been rolling in boonbanks myself. Boonies is poor people money, honsetly."]));
		chats.push(new InterestConversationalPair(interest, "It amazes me that any of the commoners are capable of anything.", ["Seriously, it's like, why not wait for your betters to instruct you.","People need to figure out where their place is.","You are so right. ", "I just regret bringing any of them into the game with us."], ["Fuck you, it's not like you'e any better than a commoner yourself.", "Knowing you consider yourself 'uncommon' almost makes me want to be common just to not share a class with YOU.", "I have never been more embarassed to be a member of the upper class.", "Learn your true place, PEON."]));
...
//	//Troll words: year, month, refrigerator, bathtub, ears, heart, brain,rap,nose,mouth,bed,tea,worm,beans,tree,legs,eyes, gold star,born,toilet,foot,spine,vampire,tits,baby,
	...
	this.chatAboutFantasy = function(p1, p2, p1Start, p2Start,relationship, relationship2){
		...
		chats.push(new InterestConversationalPair(interest, "Man, I always hoped the end of the world would have more zombies in it.", ["Yeah, but at least we're still in a desparate struggle to survive?","Yeah, shotgunkind always appealed to me.","We could pretend the imps are zombies?", "Z squad for life."], ["People died asshole. Not in your fake fucking stories, in real life. ", "Yeah, because all we fucking need is ZOMBIE underlings to fight, you asshole.", "And I here I thought you couldn't become more of an asshole. It's a motherfucking miracle."]));
		return this.processChatAboutInterests(chats, interest, p1,p2,p1Start, p2Start, relationship, relationship2)
	}
	...
	this.clubsChat = function(relationship1, relationship2){
		...
		chats.push( new ConversationalPair("Have you tried talking to your... enemy?",["Fuck you.","No. Just. Fuck that guy.","You can't make me.", "Yeah, I tried to shank them."]));
		chats.push( new ConversationalPair("So, I think I've made some progress with the other guy? You just have to agree to stop fucking with 'em.",["Hell no, that asshole deserves it.","No. Just. Fuck that guy.","You can't make me.", "I will stop fucking with them when they stop being so easily fuckable. Wait, no thats not what I meant!"]));
		chats.push( new ConversationalPair("You two are a menace to yourselves and each other. Desist, or I will assist you in desisting.",["Fuck no, you're not the boss of me!","Fine, WHATEVER.","Oh god please just don't hurt me."]));
		chats.push( new ConversationalPair("Progress?",["With what.","No, the bastard tried to shank me!","Just leave us alone!"]));
	...
	this.spadesChat = function(relationship1, relationship2){
		...
		var chats = [];
		chats.push( new ConversationalPair("God, how can anyone be so bad at this game? You suck.",["Fuck you, I killed that imp like a boss.","Like you're any better!","Fuck off!", "Go jump of a bridge."]));
		chats.push( new ConversationalPair("Jegus, stop hogging the grist!",["Make me!","Fuck you, I earned it!","Well, YOU stop hogging the echeladder rungs!", "Eat shit, asshole."]));
		...
		chats.push( new ConversationalPair("Fuck you.",["What the hell, man!?","Fuck you too.","I don't have to put up with this.", "Buy me a drink first.", "Name a time and place."]));
		...
		chats.push( new ConversationalPair("Leave me alone!",["Like hell I will, this is the most fun I've had all day.","You're the one who's all up in my grill! My grill is practically your prison!","Aw, come on, you don't mean that, do you asshole?", "No can do, we are motherfuckin entrenched in this bitch.", "AND IT DON'T STOP."]));
